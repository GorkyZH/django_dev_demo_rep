...
def add_event(request):
    ...
    try: Event.objects.create(id=eid,name=name,limit=limit,address=address,
...
def add_guest(request):
    ...
    realname = request.POST.get('realname','')    # 关联发布会
    ...
    try:Guest.objects.create(realname=realname,phone=phone,email=email,
                            sign=0,event_id=eid)
    except IntegrityError as e:
        error = "the event guest phone number repeat"
